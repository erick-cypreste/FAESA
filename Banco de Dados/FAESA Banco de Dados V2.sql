/* Este arquivo contem o Script para cria� e carga do Modelo de Dados de Clientes que ser�tilizado durante as aulas de laborat� da linguagem SQL. Nele est�contidos os comandos para cria� das tabelas que comp�em o modelo assim como dos comandos que far�a povoa� dos dados dessas tabelas. 
